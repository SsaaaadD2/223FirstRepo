...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "d39859443b60a4081cfc84fd85d72747";
    ...
    private void getWeatherForCurrentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                Log.d("Clima", "Location updated");
                Log.d("Clima", "Latitude: " + location.getLatitude() +
    ...
    public void letsDoSomeNetworking(RequestParams params){
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler(){
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                Log.d("Clima", "Could not get data");
                Log.d("Clima", headers.toString());
    ...
    public void updateUI(WeatherDataModel weatherData){
        ...
        String drawableName = weatherData.getIconName();
